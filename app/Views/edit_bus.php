...
<head>
    ...
    <title>Edit Bus | BusBook cPanel</title>
    ...
    $("#discardBus").on("click", function(){
        Swal.fire({
            ...
            if (result.isConfirmed) { //  when confirm button (yes) is clicked
                ...
                setTimeout(() => {
                    location.href = "<?=base_url()?>/buses/view/<?=$bus->bus_id?>"
                }, 1200)
