...
<head>
    ...
    <title>Add Destination | BusBook cPanel</title>
        ...
        <div class="main-content">
            <div class="container-fluid">
                        ...
                        <div class="col-lg-4">
                            <nav class="breadcrumb-container" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a loading="true" href="<?= base_url(); ?>/destinations">Destinations</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header"><h3>Add Destination</h3></div>
                            <div class="card-body">
                                <form action="<?=base_url()?>/destinations/add" method="post">
                                <div class="form-group">
                                    <label for="destination">Destination</label>
                                    <input type="text" class="form-control" required id="destination" name="destination" placeholder="eg. Tema">
                                </div>
