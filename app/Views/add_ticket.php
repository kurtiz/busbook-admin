...
<head>
    ...
    <title>Add Ticket | BusBook cPanel</title>
        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header"><h3>Add Ticket</h3></div>
                            <div class="card-body">
                                <form action="<?= base_url() ?>/tickets/add" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php if (is_array($buses)): ?>
                                            <select id="bus" required name="bus"
                                                ...
                                                <?php foreach ($buses as $bus): ?>
                                                    <option value="<?= $bus['bus_id'] ?>"><?= $bus['bus_model'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        <?php else: ?>
                                            <select id="driver" name="driver"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" required class="form-control form-control-uppercase"
                                               name="ticket_cost" id="ticket_cost" min="0" step="0.01">
                                    </div>
                                    <div class="form-group">
                                        <label>Image</label>
