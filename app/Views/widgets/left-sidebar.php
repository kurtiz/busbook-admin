                    ...
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div class="nav-item <?=session()->getTempdata('store')?> has-sub">
                                ...
                                <div class="submenu-content">
                                    <?php /* <a loading="true" href="<?= base_url(); ?>/store" class="menu-item"><i class="fas fa-store"></i><span>Store Front</span></a>
                                    <div class="nav-item has-sub">
                                    ...
                                    <a href="<?= base_url(); ?>/orders" class="menu-item"><i class="ik ik-shopping-cart"></i><span>Orders</span></a>
                                </div>
                            </div>
